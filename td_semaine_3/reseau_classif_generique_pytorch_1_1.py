    ...
    def apprentissage(self, x, y):
        ...
        while t < min(max_epoques, self.nb_epoques):
            ...
            with torch.no_grad():
                ...
                erreur_train = 1 - torch.mean((pred_train == train_data.tensors[1]).type(torch.FloatTensor))
            ...
            if early_stopping:
                ...
                with torch.no_grad():
                    ...
                    erreur_valid = 1 - torch.mean((pred_valid == valid_data.tensors[1]).type(torch.FloatTensor))
